...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 03, 2023 at 08:24 AM
...
(1, NULL, 'Namaedit', 'Jenis', 'Desc', NULL, 'Status');
...
(1, NULL, 'Tagihan', 'Transfer Bank', 'Lunas'),
(2, NULL, 'Tagihan', 'Transfer Bank', 'Belum Lunas');
...
(1, NULL, 'Nama1', 'Jenis', 1000000, 'Status'),
(4, NULL, 'Nama', 'cek', 1000000, 'Status');
...
--
ALTER TABLE `user`
  MODIFY `id_user` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3003;
