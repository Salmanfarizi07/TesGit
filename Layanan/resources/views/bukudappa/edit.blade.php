        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <form action="{{ route('bukudappa.update', $bukudappa->IDBuku) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')

                            <div class="form-group">
                                <label class="font-weight-bold">ID Buku</label>
                                <input type="text" class="form-control @error('IDBuku') is-invalid @enderror" name="IDBuku" value="{{ old('IDBuku', $bukudappa->IDBuku) }}" placeholder="Masukkan ID">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('TahunTerbit') is-invalid @enderror" name="TahunTerbit" value="{{ old('TahunTerbit', $Buku_lala->TahunTerbit) }}" placeholder="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('JumlahStok') is-invalid @enderror" name="JumlahStok" value="{{ old('JumlahStok', $Buku_lala->JumlahStok) }}" placeholder="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('DendaBuku') is-invalid @enderror" name="DendaBuku" value="{{ old('DendaBuku', $Buku_lala->DendaBuku) }}" placeholder="">
